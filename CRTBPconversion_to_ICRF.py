...
if datapack==1:
    ...
    plt.legend(['Trajectory Moon', 'Earth', 'Initial state LUMIO', 'Initial state Moon',
...
if datapack==1:
    ...
    plt.plot(x_LUMIO_tudat[:, 0], x_LUMIO_tudat[:, 1], color='red')
    plt.legend(['Trajectory Moon', 'Earth', 'Initial state LUMIO', 'Initial state Moon',
            'Trajectory LUMIO datapack', 'Initial state LUMIO datapack', 'Trajectory Moon datapack', 'Initial state Moon datapack', 'LUMIO tudat'])
else:
    plt.legend(['Trajectory LUMIO', 'Trajectory Moon', 'Earth', 'Initial state LUMIO', 'Initial state Moon'])
