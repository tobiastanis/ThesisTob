...
"""
printje = 0     # Toggle 1 for print max and min values distance L2 and LLO and L2 and Moon
norm_plots = 0      # Toggle 1 for plot several figures of the simulation of one nominal orbit
...
#x_L2_i = I.x_norm
x_L2_i = Datapack_to_initial_CRTBP.x_norm_initial
